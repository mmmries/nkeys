defmodule NKEYS do
  ...
  @prefix_seed 18 # Base32-encodes to 'S...'
  ...
  def from_seed(seed) when is_binary(seed) do
    with {:ok, binary} <- Base.decode32(seed, case: :mixed, padding: false),
         <<p1::size(5), p2::size(5), _::size(6), raw_seed::binary-size(32), _crc::size(16)-little>> <- binary,
